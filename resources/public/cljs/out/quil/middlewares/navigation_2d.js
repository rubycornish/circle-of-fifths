...
return cljs.core.merge.call(null,initial_state,p1__27316_SHARP_);
});})(initial_state))
);
});
/**
...
var nav_2d_27317 = new cljs.core.Keyword(null,"navigation-2d","navigation-2d",-1924168611).cljs$core$IFn$_invoke$arity$1(state);
var zoom_27318 = new cljs.core.Keyword(null,"zoom","zoom",-1827487038).cljs$core$IFn$_invoke$arity$1(nav_2d_27317);
var pos_27319 = new cljs.core.Keyword(null,"position","position",-2011731912).cljs$core$IFn$_invoke$arity$1(nav_2d_27317);
quil.core.scale.call(null,zoom_27318);

var tr__27239__auto___27320 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [(((quil.core.width.call(null) / (2)) / zoom_27318) - cljs.core.first.call(null,pos_27319)),(((quil.core.height.call(null) / (2)) / zoom_27318) - cljs.core.second.call(null,pos_27319))], null);
quil.core.push_matrix.call(null);

try{quil.core.translate.call(null,tr__27239__auto___27320);
...
//# sourceMappingURL=navigation_2d.js.map?rel=1506684302471