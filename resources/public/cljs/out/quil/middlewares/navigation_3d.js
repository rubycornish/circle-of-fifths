...
var vec__26788 = axis;
var a_x = cljs.core.nth.call(null,vec__26788,(0),null);
var a_y = cljs.core.nth.call(null,vec__26788,(1),null);
var a_z = cljs.core.nth.call(null,vec__26788,(2),null);
var vec__26791 = v;
var x = cljs.core.nth.call(null,vec__26791,(0),null);
var y = cljs.core.nth.call(null,vec__26791,(1),null);
var z = cljs.core.nth.call(null,vec__26791,(2),null);
 ...
 */
quil.middlewares.navigation_3d.cross_product = (function quil$middlewares$navigation_3d$cross_product(p__26794,p__26795){
var vec__26802 = p__26794;
var u1 = cljs.core.nth.call(null,vec__26802,(0),null);
var u2 = cljs.core.nth.call(null,vec__26802,(1),null);
var u3 = cljs.core.nth.call(null,vec__26802,(2),null);
var vec__26805 = p__26795;
var v1 = cljs.core.nth.call(null,vec__26805,(0),null);
var v2 = cljs.core.nth.call(null,vec__26805,(1),null);
var v3 = cljs.core.nth.call(null,vec__26805,(2),null);
...
return cljs.core.mapv.call(null,(function (p1__26808_SHARP_){
return (p1__26808_SHARP_ * mult);
}),v);
});
/**
 * Sum of 2 vectors.
...
return quil.middlewares.navigation_3d.rotate_by_axis_and_angle.call(null,p1__26809_SHARP_,axis,angle);
});})(axis))
;
...
return quil.middlewares.navigation_3d.rotate_ud.call(null,quil.middlewares.navigation_3d.rotate_lr.call(null,p1__26810_SHARP_,angle_lr),angle_ud);
...
var map__26817 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
...
var up = cljs.core.get.call(null,map__26817__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var straight = cljs.core.get.call(null,map__26817__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var temp__4655__auto__ = (function (){var pred__26819 = cljs.core._EQ_;
var expr__26820 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(event);
if(cljs.core.truth_(pred__26819.call(null,new cljs.core.Keyword(null,"w","w",354169001),expr__26820))){
return straight;
} else {
if(cljs.core.truth_(pred__26819.call(null,new cljs.core.Keyword(null,"s","s",1705939918),expr__26820))){
return quil.middlewares.navigation_3d.v_opposite.call(null,straight);
} else {
if(cljs.core.truth_(pred__26819.call(null,quil.middlewares.navigation_3d.space,expr__26820))){
return quil.middlewares.navigation_3d.v_opposite.call(null,up);
} else {
if(cljs.core.truth_(pred__26819.call(null,new cljs.core.Keyword(null,"z","z",-789527183),expr__26820))){
return up;
} else {
if(cljs.core.truth_(pred__26819.call(null,new cljs.core.Keyword(null,"d","d",1972142424),expr__26820))){
return quil.middlewares.navigation_3d.cross_product.call(null,straight,up);
} else {
if(cljs.core.truth_(pred__26819.call(null,new cljs.core.Keyword(null,"a","a",-2123407586),expr__26820))){
...
return cljs.core.update_in.call(null,state,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301),new cljs.core.Keyword(null,"position","position",-2011731912)], null),((function (dir,temp__4655__auto__,map__26817,map__26817__$1,up,straight){
return (function (p1__26811_SHARP_){
return quil.middlewares.navigation_3d.v_plus.call(null,p1__26811_SHARP_,quil.middlewares.navigation_3d.v_mult.call(null,dir,step_size));
});})(dir,temp__4655__auto__,map__26817,map__26817__$1,up,straight))
);
} else {
return state;
}
...
return cljs.core.merge.call(null,initial_state,p1__26822_SHARP_);
});})(initial_state))
);
});
/**
...
var map__26834_26845 = new cljs.core.Keyword(null,"navigation-3d","navigation-3d",682305301).cljs$core$IFn$_invoke$arity$1(state);
var map__26834_26846__$1 = ((((!((map__26834_26845 == null)))?((((map__26834_26845.cljs$lang$protocol_mask$partition0$ & (64))) || (map__26834_26845.cljs$core$ISeq$))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__26834_26845):map__26834_26845);
var vec__26835_26847 = cljs.core.get.call(null,map__26834_26846__$1,new cljs.core.Keyword(null,"straight","straight",-1252567854));
var c_x_26848 = cljs.core.nth.call(null,vec__26835_26847,(0),null);
var c_y_26849 = cljs.core.nth.call(null,vec__26835_26847,(1),null);
var c_z_26850 = cljs.core.nth.call(null,vec__26835_26847,(2),null);
var vec__26838_26851 = cljs.core.get.call(null,map__26834_26846__$1,new cljs.core.Keyword(null,"up","up",-269712113));
var u_x_26852 = cljs.core.nth.call(null,vec__26838_26851,(0),null);
var u_y_26853 = cljs.core.nth.call(null,vec__26838_26851,(1),null);
var u_z_26854 = cljs.core.nth.call(null,vec__26838_26851,(2),null);
var vec__26841_26855 = cljs.core.get.call(null,map__26834_26846__$1,new cljs.core.Keyword(null,"position","position",-2011731912));
var p_x_26856 = cljs.core.nth.call(null,vec__26841_26855,(0),null);
var p_y_26857 = cljs.core.nth.call(null,vec__26841_26855,(1),null);
var p_z_26858 = cljs.core.nth.call(null,vec__26841_26855,(2),null);
quil.core.camera.call(null,p_x_26856,p_y_26857,p_z_26858,(p_x_26856 + c_x_26848),(p_y_26857 + c_y_26849),(p_z_26858 + c_z_26850),u_x_26852,u_y_26853,u_z_26854);
...
//# sourceMappingURL=navigation_3d.js.map?rel=1506684302001